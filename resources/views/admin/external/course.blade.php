...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card">
            <h3 class="card-title">添加外部类型</h3>
            <form action="{{ route('admin.external.type.store') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label class="form-label">外部类型</label>
                    <input type="text" name="type" required class="form-input" placeholder="请输入外部类型名称">
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions">
                                        ...
                                        <form action="{{ route('admin.external.type.destroy', $type->id) }}" 
                                              method="POST" style="display: inline;" 
                                              onsubmit="return confirm('确定要删除这个外部类型吗？')">
                                            @csrf
                                            @method('DELETE')
    ...
    <div class="modal-overlay" id="editModal">
        <div class="modal">
            <div class="modal-header">
                <h3 class="modal-title">编辑外部类型</h3>
            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    <div class="form-group">
                        <label class="form-label">外部类型</label>
                        <input type="text" id="editTypeInput" name="type" required class="form-input" placeholder="请输入外部类型名称">
                    </div>
    ...
    <script>
        ...
        document.getElementById('editForm').addEventListener('submit', function(e) {
            ...
            fetch('{{ route('admin.external.type.update', ':id') }}'.replace(':id', currentEditId), {
                method: 'PUT',
                headers: {
